                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <span class="badge badge-sm bg-gradient-success">Rp.250.000</span>
                                        </td>
                                        <td align="center">
                                            <a href="javascript:;" class="btn btn-primary font-weight-bold text-xs"
                                                data-toggle="tooltip" data-original-title="Edit Paket Wisata">
                                                Edit
                                            </a>
                                            <a href="javascript:;" class="btn btn-danger font-weight-bold text-xs"
                                                data-toggle="tooltip" data-original-title="Hapus Paket Wisata">
                                                Hapus
                                            </a>
                                        </td>
                                    </tr>
